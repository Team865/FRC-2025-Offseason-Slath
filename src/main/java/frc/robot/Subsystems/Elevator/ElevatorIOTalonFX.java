...
public class ElevatorIOTalonFX implements ElevatorIO {
    ...
    private final MotionMagicVoltage motionRequest =
            new MotionMagicVoltage(0.0).withEnableFOC(true).withUpdateFreqHz(50.0);
    ...
    public ElevatorIOTalonFX() {
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50.0, appliedVolts, supplyCurrent, statorCurrent, position, velocity);
    }
